...
for (let i = 0; i < trendings.length; i++) {
  let active = i === 0 ? 'active' : ''; // Corrigido para lógica de "active"
  carousel.innerHTML += `
...
// Variáveis de scroll de Trending Movies
...
// Variáveis de scroll de TopRated Movies
...
if (scrollDirectionTopRated !== 0) {
  containerTopRated.scrollLeft += scrollDirectionTopRated * 6; // Ajuste a velocidade (6 = rápido)
}
}

// Inicia o intervalo de verificação
scrollIntervalTopRated = setInterval